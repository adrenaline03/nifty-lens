...
st.markdown("---")
st.caption(
  "Data via yfinance. Prices are split/dividend adjusted. "
  "Volatility regime predictions from an XGBoost classifier trained on 12 "
  "engineered features. This is a portfolio project — not investment advice."
)